...
public class SecurityConfiguration {
	...
	// Configure the bean to customize spring security filter chain
		...
		public SecurityFilterChain authorizeRequests(HttpSecurity http) throws Exception
		{
	       ...
	       .hasRole("MERCHANT")
	       .requestMatchers("/products/add","users/deactivate","products/user-products","/products/delete")
	       .hasRole("FARMER") 
	       .requestMatchers("/products/view-products","/products/view","users/list","users/delete/**")
	       .hasRole("ADMIN")
